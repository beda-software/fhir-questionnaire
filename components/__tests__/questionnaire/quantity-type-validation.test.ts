...
import { questionnaireItemsToValidationSchema } from '../../../components/QuestionnaireResponseForm/BaseQuestionnaireResponseForm/utils';
...
describe('Quantity type validation', () => {
    describe('Individual test cases', () => {
        test.each(QUANTITY_TEST_DATA)('$description', async (testData) => {
            const validationSchema = questionnaireItemsToValidationSchema(testData.questionnaire.item ?? []);
    ...
    describe('Comparator validation', () => {
        test('should validate all FHIR-compliant comparator values', async () => {
            ...
            for (const comparator of validComparators) {
                ...
                const validationSchema = questionnaireItemsToValidationSchema(questionnaire.item ?? []);
