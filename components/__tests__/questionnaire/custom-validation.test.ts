...
} from '../../QuestionnaireResponseForm/BaseQuestionnaireResponseForm/utils';
...
describe('Complex type validation', () => {
    test.each(QUESTIONNAIRES_TEST_DATA)('should return the correct result', async (questionnaireData) => {
        const validationSchema = questionnaireItemsToValidationSchema(
            questionnaireData.questionnaire.item ?? [],
            customYupTestsMap,
        );
